...
func Test_prompt(t *testing.T) {
	...
	//read the output from prompt() from read pipe
	out, _ := io.ReadAll(r)
...
func Test_checkNumbers(t *testing.T) {
	tests := []struct {
		...
		{name: "typed", input: "four", expected: "Please enter a whole number!"},
		{name: "decimal", input: "2.5", expected: "Please enter a whole number!"},
		{name: "quit", input: "q", expected: ""},
		{name: "QUIT", input: "Q", expected: ""},
		{name: "greek", input: "ςς", expected: "Please enter a whole number!"},
	}
